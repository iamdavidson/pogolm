...
class PoseGraph : public rclcpp::Node {
  ...
  private:
	...
	rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr
		pc_subscriber;
	rclcpp::Subscription<pogolm_interfaces::msg::LoopEdge>::SharedPtr
		le_subscriber;
	rclcpp::Publisher<factor_graph_interfaces::msg::FactorGraph>::SharedPtr
		fg_publisher;
    rclcpp::Publisher<pogolm_interfaces::msg::Key>::SharedPtr
        pc_key_publisher;
	...
	rclcpp::Subscription<std_msgs::msg::Empty>::SharedPtr 
        trigger_subscriber;
	rclcpp::Publisher<pogolm_interfaces::msg::FactorGraphDebug>::SharedPtr
		fg_debug_publisher;
	rclcpp::Publisher<pogolm_interfaces::msg::MergedInfo>::SharedPtr
		merge_info_pub;
    rclcpp::Publisher<pogolm_interfaces::msg::LoopEdgeTracker>::SharedPtr
        loop_tracker_pub;

    // Services
    rclcpp::Service<pogolm_interfaces::srv::StoreLandmark>::SharedPtr 
        store_landmark_srv;
    rclcpp::Service<pogolm_interfaces::srv::QueryLandmark>::SharedPtr 
        query_landmark_srv;
    ...
    std::atomic_bool 
        ...
        optim_in_process{false},
        loop_edge_buffered{false},
    ...
    pc_filter(sensor_msgs::msg::PointCloud2::UniquePtr in_pc2);
    ...
    void print_found_neighbors(const uint64_t &query_key,
  ...
  public:
    ...
    std::vector<uint64_t> add_landmark(const gtsam::Point3 &p,
    ...
    std::vector<std::shared_ptr<Landmark>> get_neighbors_range_by_label (const float radius, const std::string query_label);
...
public:
    ...
    PoseGraphComponent(const rclcpp::NodeOptions& options)
    : PoseGraph(options) {}
