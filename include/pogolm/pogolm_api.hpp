...
template <class T>
struct key_query : false_type
{
};
template <class T>
struct lm_query : false_type
{
};
template <class T>
struct label_query : false_type
{
};
template <class T>
struct int_prop : false_type
{
};
template <class T>
struct float_prop : false_type
{
};
template <>
struct key_query<uint64_t> : true_type
{
};
template <>
struct label_query<std::string> : true_type
{
};
template <>
struct label_query<const char*> : true_type
{
};
template <>
struct label_query<char*> : true_type
{
};
template <>
struct lm_query<Landmark> : true_type
{
};
template <>
struct int_prop<int> : true_type
{
};
template <>
struct float_prop<float> : true_type
{
};
...
public:
  ...
  inline std::vector<uint64_t> store_landmark(const Point3d& p, const std::string label = "LM",
  ...
  std::vector<std::shared_ptr<Landmark>> get_lm(const K& query_elm)
  {
  ...
  std::vector<std::shared_ptr<Landmark>> get_neighbors(const K& query_elm, const V& search_property)
  {
    std::vector<std::shared_ptr<Landmark>> res;
  ...
  inline std::vector<std::shared_ptr<Landmark>> has_neighbors(const Point3d& query_elm, const float range,
                                                              const float eps)
  {
    if (!pose_graph_)
      return {};
    ...
    lm.point = LMPoint{ static_cast<float>(q_g.x()), static_cast<float>(q_g.y()), static_cast<float>(q_g.z()), lm.key };
