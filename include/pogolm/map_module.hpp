...
private:
  ...
  // service servers
  rclcpp::Service<pogolm_interfaces::srv::GetMap>::SharedPtr get_map_srv;
  ...
  void handle_map_request(const std::shared_ptr<pogolm_interfaces::srv::GetMap::Request> request,
...
{
public:
  MapModuleComponent(const rclcpp::NodeOptions& options) : MapModule(options)
  {
  }
};
